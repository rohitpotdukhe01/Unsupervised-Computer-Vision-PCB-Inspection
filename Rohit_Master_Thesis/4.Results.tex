...
From the results of confusion matrix, we can see that the performance was terrible as the model classified all the images whether it's normal or abnormal images as abnormal.
