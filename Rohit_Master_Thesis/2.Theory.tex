...
\gls{yolo} & Real-time object detection; maps pixels to bounding box coordinates and class probabilities \\ \hline
PatchCore & Uses locally-aware patch features and memory banks for anomaly detection \\ \hline
\gls{dfm} & Models normal data distribution using deep feature extraction and density modeling \\ \hline
...
\gls{dfkde} & Extracts features with \gls{dnn} and applies Kernel Density Estimation on reduced features \\ \hline
\end{tabular}%
}
